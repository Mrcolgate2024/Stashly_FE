...
interface RiskAnalystAvatarProps {
...
export const RiskAnalystAvatar: React.FC<RiskAnalystAvatarProps> = ({
  ...
  return (
    <BaseAvatar
      ...
      token={RISK_ANALYST_TOKEN}
      eventName="simli:risk:message"
      position="right"
      bgColor="bg-blue-500"
